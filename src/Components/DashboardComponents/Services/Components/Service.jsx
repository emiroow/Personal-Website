...
import { fetchDeleteAdminService } from '../../../../Reducers/DashboardSlices/ServiceSlice';
        ...
        <>
            ...
            <div className='md:w-[25%] h-max w-full mx-4 my-4 space-y-3 p-5 border-2 dark:border-white border-LightMaincolor rounded-lg'>
                <div>
                    ...
                    <input disabled={isVisiblty} defaultValue={data.title} className='mt-1 w-full p-2 border-2 border-green-500 text-MainColorDark text-center rounded-lg outline-green-500 dark:outline-DarkPurple' type="text" name="" id="" />
                </div>
                <div>
                    <label className='text-LightMaincolor dark:text-white' htmlFor="">{t("ValueLabel")} :</label>
                    <textarea disabled={isVisiblty} defaultValue={data.description} className='mt-1 border-2 border-green-500 w-full p-2 text-sm text-MainColorDark rounded-lg outline-green-500 dark:outline-DarkPurple' rows="5"></textarea>
                </div>
