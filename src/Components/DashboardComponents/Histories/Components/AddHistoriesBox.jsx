...
export default function AddEducationBox({
  AddEducationArr,
  SetEducationArr,
  TabState,
}) {
            ...
            <div className=" border-y-2 pb-8 dark:border-DarkPurple w-full  p-4 rounded-xl  mr-auto ">
              <div className="flex flex-col mb-4">
                ...
                <input
                  ...
                  name="title"
                  ref={title}
                  className={` text-center shadow-[0px_0px_10px_0px_rgba(0,0,0,0.35)] text-black lg:w-[60%] h-10 mt-1 rounded-md mb-2 outline-none dark:shadow-[0px_0px_10px_0px_rgba(0,0,0,0.25)]`}
                />
              </div>
              <div className="flex flex-col mb-4">
              ...
              <div className="flex flex-col mb-5">
                ...
                <textarea
                  name="description"
                  ref={description}
                  className="outline-none p-3 shadow-[0px_0px_10px_0px_rgba(0,0,0,0.35)] text-black rounded-xl"
                  id=""
                  rows="5"
                ></textarea>
              </div>
  ...
  const HandleAddAnalys = () => {
    SetEducationArr(
      AddEducationArr.concat(<NewAnalys key={AddEducationArr.length} />)
    );
  };
