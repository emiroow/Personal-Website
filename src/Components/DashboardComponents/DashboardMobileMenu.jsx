  ...
  return (
    <>
      <div
        className={
          sidestatus
            ? "fixed dark:bg-BackColor bg-LightMaincolor border-r-2 dark:border-DarkPurple border-LightYellow shadow-[0px_0px_10px_0px_rgba(0,0,0,0.40)] w-[23%] h-full z-50 top-0 duration-700 left-0"
