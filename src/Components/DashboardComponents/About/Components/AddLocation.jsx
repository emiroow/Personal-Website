  ...
  const AcceptBtn = () => {
    if (locationAddress) {
      ...
      if (Parsed.lat !== GetPosition.lat) {
        return (
          <button
            onClick={handleSubmitselectedMap}
            className="px-5 py-2 bg-green-500 mx-2 rounded-lg"
          >
            {t("AcceptLocation")}
          </button>
        );
        ...
        return (
          <>
            ...
            <button
              onClick={handleSubmitselectedMap}
              className="w-max mt-3 px-5 py-2 bg-red-500 mx-2 rounded-lg"
            >
              {t("CancelLocation")}
            </button>
          </>
  ...
  return (
    <>
      <button
        ...
        className="h-10 p-3 bg-black rounded-xl flex items-center "
      >
