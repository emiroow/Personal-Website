  ...
  return (
    <>
      <div
        className={
          sidestatus
            ? "fixed dark:bg-BackColor bg-LightMaincolor border-r-2 dark:border-DarkPurple mt- border-LightYellow shadow-[0px_0px_10px_0px_rgba(0,0,0,0.40)] w-[23%] h-full z-50 top-0 duration-700 left-0"
            : "fixed  bg-BackColor shadow-[0px_0px_10px_0px_rgba(0,0,0,0.40)] w-[23%] h-full z-50 top-0 -left-[100%]"
        }
      >
        <div className="w-full flex-col relative flex mt-10 items-center ">
          <div className="space-y-20 mb-24 ">
            <div>
              <Language sidesetstatue={sidesetstatue} />
            </div>
            <div>
              <Toggle />
            </div>
      ...
      <div
        onClick={(e) => sidesetstatue(false)}
        className={
          sidestatus
            ? "w-full  z-10 bg-black/40 h-[100vh] fixed top-0 duration-700 right-0"
            : "w-full z-10 bg-black/40 h-[100vh] fixed top-0 duration-100 -right-[100%]"
        }
      ></div>
    </>
  );
