...
export default function DownloadCv() {
    ...
    const aboutData = useSelector((store) => store.client.clientState.about.cvUrl)
    return (
        <div className='w-full flex justify-center items-center'>
            <div className='w-[80%] flex-wrap flex flex-col justify-center items-center pb-5 pt-5'>
                <a href={aboutData} className="w-[75%] flex items-center justify-center  dark:bg-DarkPurple bg-LightYellowDark rounded-md text-center p-2 font-IranBold">
