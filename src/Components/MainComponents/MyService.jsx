...
export default function MyService() {
    ...
    return (
        <div className='my-5 md:my-16'>
            ...
            <div className=' w-[98%] md:w-[95%] 2xl:w-[93%] m-auto flex justify-center md:justify-between flex-row flex-wrap'>
                {
                    getData?.map((item, index) => {
                        return (
                            <div key={index} className=' max-md:mb-3 shadow-[0px_0px_10px_0px_rgba(0,0,0,0.40)] w-[95%]  md:w-[30%] dark:bg-BackColorWhiter bg-LightMaincolor border-2 dark:border-DarkPurple rounded-md p-3 border-LightYellow'>
