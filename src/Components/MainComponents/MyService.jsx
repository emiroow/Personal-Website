    ...
    return (
        <>
            ...
            <div className=' w-[98%] md:w-[95%] 2xl:w-[93%] m-auto flex justify-between flex-row flex-wrap'>
                <div className=' mb-5 shadow-[0px_0px_10px_0px_rgba(0,0,0,0.40)] w-[95%] max-md:m-auto max-md:mb-2 md:w-[30%] dark:bg-BackColorWhiter bg-LightMaincolor border-2 dark:border-DarkPurple rounded-md p-3 border-LightYellow'>
