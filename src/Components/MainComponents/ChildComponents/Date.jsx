      ...
      <div className="flex flex-col md:grid grid-cols-12 text-gray-50  mb-8">
        <div className="flex md:contents">
          ...
          <div className=" col-start-2 col-end-12 p-4 rounded-xl  mr-auto w-full">
            <h3 className="font-semibold text-md 2xl:text-lg mb-1 font-IranBold text-shadow-dark ">
              {title}
            </h3>
            <p
              className={`${
                i18n.language === "en" ? "border-l-2  pl-2" : "border-r-2  pr-2"
              } leading-tight text-[12px] text-justify mt-2 mb-1 space-y-1  dark:border-DarkPurple border-LightBackcolor w-full text-sm 2xl:text-md font-IranBold dark:text-DarkPurple text-LightBackcolor`}
            >
              {type === "educations" ? (
                <>
                  <p>
                    <span className="text-white font-IranLight">
                      {t("historyDate")} :
                    </span>
