...
function Portfolio({ data }) {
    return (
        <div key={data.portfolioId} className=" shadow-[0px_0px_10px_0px_rgba(0,0,0,0.40)] h-max max-lg:mb-4 rounded-lg dark:border-DarkPurple border-LightMaincolor border-[2.5px] md:mx-4 2xl:mx-5 ">
