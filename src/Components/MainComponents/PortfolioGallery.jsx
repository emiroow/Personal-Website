                    ...
                    GetImgs.map((item, i) => {
                        return (
                            <div key={i} className="relative shadow-[0px_0px_10px_0px_rgba(0,0,0,0.40)] mb-5 group md:mx-4 2xl:mx-5 ">
                                ...
                                <img className='md:w-[250px] 2xl:w-[340px] cursor-pointer rounded-lg dark:border-DarkPurple border-LightMaincolor drop-shadow-xl border-[2.5px] bg-cover bg-no-repeat' src={item.src} alt="" />
                            </div>
                        )
                    })
                }
