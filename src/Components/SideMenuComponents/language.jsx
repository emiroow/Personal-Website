    ...
    <>
      <div className='relative'>
        <div className='w-full flex justify-center items-center'>
          <MdOutlineLanguage onClick={() => SetLangState(!GetLangState)} className='transition duration-700 ease-in-out  hover:-translate-y-1 hover:scale-60  text-DarkPurple text-[30px] lg:text-[35px] xl:text-[38px] 2xl:text-[42px] cursor-pointer' />
        </div>
        {GetLangState ? (
          <div className='ease-in duration-300 absolute top-9 right-0 flex justify-center items-center  w-full'>
