...
export default function Login() {
  ...
  const schema = Yup.object().shape({
    ...
    password: Yup.string().required(t("Passwordrequired")).min(5, t("min")),
  });
  ...
  return (
    <>
      ...
      <div className="w-full h-[97vh] flex-col font-IranBold flex justify-center items-center m-auto">
        ...
        <h1 className="mb-5 text-shadow-purple text-4xl">{t("Title")}</h1>
            ...
            {({
              ...
              <form onSubmit={handleSubmit}>
                ...
                <input
                  ...
                  name="user"
                  id="user"
                  className="w-full h-10 rounded-md mb-3 outline-none bg-LightBackcolor/30 dark:bg-white/30 text-center dark:shadow-[0px_0px_10px_0px_rgba(0,0,0,0.25)]"
                />
                ...
                <input
                  type="submit"
                  value={t("login")}
                  className="mt-2 cursor-pointer bg-LightYellow dark:bg-DarkPurple shadow-[0px_0px_10px_0px_rgba(0,0,0,0.25)] rounded-md py-2 w-max m-auto px-8"
                />
              </form>
            )}
          </Formik>
